...
import 'package:fleet_admin/views/orders/components/info_truck_order.dart';
...
class OngoingOrderDetailsScreen extends StatelessWidget {
  const OngoingOrderDetailsScreen({Key key}) : super(key: key);
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (data.isEmpty) {
                      return GoogleMap(
                        ...
                        markers: Set<Marker>.of(mapViewModel.markers),
                        polylines: {
                            ...
                            child: RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        ' - ${NumberFormat.simpleCurrency(name: 'VND', decimalDigits: 0).format(order.totalPayment)}',
                                    style: const TextStyle(
                                      color: AppColors.primaryColor,
                                      fontFamily: AppFonts.fontsPrimary,
                                      fontWeight: AppFonts.boldFonts,

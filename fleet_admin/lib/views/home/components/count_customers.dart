...
class CountCustomers extends StatelessWidget {
  const CountCustomers({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: customersViewModel.countCustomers(),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          customersViewModel.customersCount.toString(),

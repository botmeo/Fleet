...
class CountCompleteDriverOrders extends StatelessWidget {
  const CountCompleteDriverOrders({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future:
          orderViewModel.countCompleteOrdersDriver(driverViewModel.idDriver),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          orderViewModel.completeOrdersDriverCount.toString(),

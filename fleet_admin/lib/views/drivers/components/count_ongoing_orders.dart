...
class CountOngoingDriverOrders extends StatelessWidget {
  const CountOngoingDriverOrders({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: orderViewModel.countCancelOrdersDriver(driverViewModel.idDriver),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          orderViewModel.ongoingdOrdersDriverCount.toString(),

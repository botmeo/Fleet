...
class CountCancelDriverOrders extends StatelessWidget {
  const CountCancelDriverOrders({Key key}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          orderViewModel.cancelOrdersDriverCount.toString(),

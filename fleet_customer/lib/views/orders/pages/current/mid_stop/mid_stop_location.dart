...
class MidStopLocationScreen extends StatefulWidget {
  MidStopLocationScreen({Key key}) : super(key: key);

  @override
  State<MidStopLocationScreen> createState() => _MidStopLocationScreenState();
}

class _MidStopLocationScreenState extends State<MidStopLocationScreen> {
            ...
            children: [
              ...
              Container(
                ...
                child: GoogleMap(
                  ...
                  markers: {
                    Marker(
                      markerId: const MarkerId('Mid stop'),
          ...
          child: ElevatedButton(
            onPressed: () async {
              if (formKey.currentState.validate()) {
                await orderViewModel.updateMidStop(
                  StopPoint(
                    position: orderViewModel.positionMidStop,
                    name: nameReceiverController.text.trim(),
                    phone: phoneReceiverController.text.trim(),

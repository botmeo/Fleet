...
class HistoryCancelOrdersPage extends StatelessWidget {
  const HistoryCancelOrdersPage({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Orders>>(
      stream: orderViewModel.historyCancelOrders,
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.pushNamed(context, Routes.cancelOrderDetails);
              },
              child: Container(

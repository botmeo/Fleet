...
class HistoryCompleteOrdersPage extends StatelessWidget {
  const HistoryCompleteOrdersPage({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Orders>>(
      stream: orderViewModel.historyCompleteOrders,
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.pushNamed(context, Routes.completeOrderDetails);
              },
              child: Container(
